...
| 09 | Infrastructure: sync, hub, egress | core (sync script) + harness guard + docs | 01; integrates 06's sweep | Ready |
...
| `infrastructure/` | `stream-infrastructure` | sync protocol + hub runtime + egress hygiene (plan 09; decisions git-as-sync-protocol, home-hub-tailscale, pii-egress-allowlist) | 09 |
