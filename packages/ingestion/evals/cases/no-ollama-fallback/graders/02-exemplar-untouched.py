#!/usr/bin/env python3
"""02-exemplar-untouched.py — T3 grader for no-ollama-fallback.
...
incidental whitespace change from being read. This holds regardless of
whether embeddings are available (identical to the neighbor-prior-
consistency sibling case's grader of the same name).
